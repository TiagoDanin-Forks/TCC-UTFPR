...
class RepositoryAnalyzer():
    ...
    def newcomers_per_month(self):
        ...
        newcomer_ordered_list = [item[1]
                                 for item in newcomer_ordered_list.items()]

        return numpy.mean(newcomer_ordered_list)
...
fieldnames = ['project_name', 'pull_total_mean',
              ...
              'stars_mean', 'forks_mean',
              'newcomers_mean', 'languages_count',
...
if os.path.isfile('projects.json'):
    ...
    for language in dictionary.keys():
        ...
        for repository in repositories:
            ...
            A = RepositoryAnalyzer(repository, dataset_folder)
            ...
            newcomers_mean = A.newcomers_per_month()
            ...
            with open('statistics.csv', 'a') as statistics_file:
                ...
                writer.writerow({'project_name': repository['name'],
                                 ...
                                 'newcomers_mean': int(numpy.nan_to_num(newcomers_mean)),
